        ...
        for stream_number, v in enumerate(in_lists):
            ...
            if v.stop > v.start:
                ...
                for element in input_list:
                    ...
                    print 'asynch_element_agent. output_lists_increment', output_lists_increment
                    if num_outputs > 1:
                        assert len(output_lists_increment) == num_outputs
                        for k in range(num_outputs):
                            output_lists[k].extend([output_lists_increment[k]])
                    else:
                        output_lists[0].extend([output_lists_increment])
        print 'asynch_element_agent. output_lists', output_lists
        ...
        for stream_number, v in enumerate(in_lists):
            ...
            if v.stop > v.start:
                ...
                for element in input_list:
                    ...
                    ##         output_lists[k].append(output_lists_increment[k])
                    ## else:
                    ##     print 'output_lists_increment', output_lists_increment
                    ##     output_lists[0].extend(output_lists_increment)
